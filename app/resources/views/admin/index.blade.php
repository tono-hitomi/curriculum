...
<style>
    ...
    .table-scroll { height: 400px; overflow-y: auto; } /* 高さを固定して揃える */
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="card-footer bg-white border-top-0">
                    <a href="{{ route('admin.users.index') }}" class="btn btn-secondary admin-card-btn shadow-sm">
                        ユーザー詳細・編集を表示
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="card-footer bg-white border-top-0">
                    <a href="{{ route('admin.events.index') }}" class="btn btn-secondary admin-card-btn shadow-sm">
                        全イベント詳細を表示
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="card-footer bg-white border-top-0">
                    {{-- 違反報告一覧 --}}
                    <a href="{{ route('admin.reports.index') }}" class="btn btn-secondary admin-card-btn shadow-sm">
                        参加申込詳細一覧を表示
                    </a>
                </div>
            </div>
